defmodule PayPal.Payments.PaymentsTest do
  use ExUnit.Case
  ...
  test "create a payment" do
    use_cassette "payments_create_payment" do
      ...
      assert resp ==
               {:ok,
                %{
                  "create_time" => "2017-05-09T02:41:25Z",
                  "id" => "PAY-56X02727YH154025YLEISYVI",
                  "intent" => "sale",
                  "links" => [
                    %{
                      "href" =>
                        "https://api.sandbox.paypal.com/v1/payments/payment/PAY-56X02727YH154025YLEISYVI",
                      "method" => "GET",
                      "rel" => "self"
                    },
                    %{
                      "href" =>
                        "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-7MA403949P880733G",
                      "method" => "REDIRECT",
                      "rel" => "approval_url"
                    },
                    %{
                      "href" =>
                        "https://api.sandbox.paypal.com/v1/payments/payment/PAY-56X02727YH154025YLEISYVI/execute",
                      "method" => "POST",
                      "rel" => "execute"
                    }
                  ],
  ...
  test "execute a payment" do
    use_cassette "payments_execute_payment" do
      ...
      assert resp ==
               {:ok,
                %{
                  "cart" => "7MA403949P880733G",
                  "create_time" => "2017-05-09T02:54:15Z",
                  "id" => "PAY-56X02727YH154025YLEISYVI",
                  "intent" => "sale",
                  "links" => [
                    %{
                  ...
                  "transactions" => [
                    %{
                      ...
                      "payee" => %{
                        "email" => "paypal-facilitator@joocyluscious.com.au",
                        "merchant_id" => "G8Z6LP4WN9SP4"
                      },
                      "related_resources" => [
                        %{
                          "sale" => %{
                            ...
                            "create_time" => "2017-05-09T02:54:14Z",
                            "id" => "7UB09546JJ671102D",
                            "links" => [
                              %{
                                "href" =>
                                  "https://api.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D",
                                "method" => "GET",
                                "rel" => "self"
                              },
                              %{
                                "href" =>
                                  "https://api.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D/refund",
                                "method" => "POST",
                                "rel" => "refund"
                              },
                              %{
                            ...
                            "parent_payment" => "PAY-56X02727YH154025YLEISYVI",
                            "payment_mode" => "INSTANT_TRANSFER",
                            "protection_eligibility" => "ELIGIBLE",
                            "protection_eligibility_type" =>
                              "ITEM_NOT_RECEIVED_ELIGIBLE,UNAUTHORIZED_PAYMENT_ELIGIBLE",
                            "soft_descriptor" => "PAYPAL *TESTFACILIT ECHI5786786",
                            "state" => "completed",
                            "transaction_fee" => %{"currency" => "USD", "value" => "1.32"},
                            "update_time" => "2017-05-09T02:54:14Z"
                          }
                        }
                      ]
                    }
                ...
                %{
                  ...
                  "transactions" => [
                    %{
                      ...
                      "payee" => %{"merchant_id" => "G8Z6LP4WN9SP4"},
                      "related_resources" => [
                        %{
                          "sale" => %{
                            "amount" => %{
  ...
  test "update a payment, error" do
    use_cassette "payments_update_error" do
      resp =
        PayPal.Payments.Payments.update("PAY-56X02727YH154025YLEISYVI", [
          %{
            op: "replace",
  ...
  test "refund a sale" do
    use_cassette "sale_refund" do
      resp =
        PayPal.Payments.Sales.refund("7UB09546JJ671102D", %{
          amount: %{
            total: "1.50",
            currency: "USD"
          }
      ...
      assert resp ==
               {:ok,
                %{
                  ...
                  "create_time" => "2017-05-09T04:59:50Z",
                  "id" => "6N458369VN1308144",
                  "links" => [
                    %{
                      "href" =>
                        "https://api.sandbox.paypal.com/v1/payments/refund/6N458369VN1308144",
                      "method" => "GET",
                      "rel" => "self"
                    },
                    %{
                  ...
                  "parent_payment" => "PAY-56X02727YH154025YLEISYVI",
                  "sale_id" => "7UB09546JJ671102D",
                  "state" => "completed",
                  "update_time" => "2017-05-09T04:59:50Z"
                }}
    end
  end
